...
$dbuser = "dgr25"; //your ucid since we follow this pattern
$dbpass =  "UZhaiNDQDH5aHfF1";  //database password generated or chosen per respective steps
$dbdatabase = "dgr25";  //your ucid since we follow this pattern
?>
